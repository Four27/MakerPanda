                ...
                if (data.status === 200) {
                    ...
                    for (var i = 0; i < articleLen; i++) {
                        ...
                        var inform = $('<div class="col-sm-6 col-md-4 item"><div class="thumbnail"><div class="caption"><h3><a class="1" id="' + count + '">' +
                            list[i].artiTitle + '</a></h3><p>' + article.substr(0, 150) + '...</p></div></div></div>');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status === 200) {
                    ...
                    for (var i = 0; i < articleLen; i++) {
                        var article = list[i].artiData.replace(re1, '');
                        var inform = '<div class="col-sm-6 col-md-4 item"><div class="thumbnail"><div class="caption"><h3><a class="' + page + '" id="' + count + '">' +
                            list[i].artiTitle + '</a></h3><p>' + article.substr(0, 150) + '...</p></div></div></div>';
